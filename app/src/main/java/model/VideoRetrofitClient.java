...
public class VideoRetrofitClient {
    ...
    public static Retrofit getRetrofitVideoInstance()
    {
    ...
    public static Retrofit getRetrofitCheckVersion()
    {
        retrofit = new Retrofit.Builder()
                .client(getUnsafeOkHttpClient().build())
                .baseUrl("https://marketingvideo.zilni.com/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        return retrofit;
    }
    public static Retrofit getRetrofitVideoTrendingInstance()
    {
        retrofit = new Retrofit.Builder()
                .client(getUnsafeOkHttpClient().build())
